...
export interface ApiAboutUsAboutUs extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Website: Schema.Attribute.Enumeration<['Company Profile', 'Landing Page']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiHeroSetionHeroSetion extends Struct.SingleTypeSchema {
  collectionName: 'hero_setions';
  info: {
    description: '';
    displayName: 'Hero Setion';
    pluralName: 'hero-setions';
    singularName: 'hero-setion';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::hero-setion.hero-setion': ApiHeroSetionHeroSetion;
